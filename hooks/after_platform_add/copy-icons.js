...
var icons = {
  ios: {
      ...
      "identifier_ios_152x152_1.png": projName + "/Resources/icons/icon-60@3x.png",
      "identifier_ios_152x152_2.png": projName + "/Resources/icons/icon-76@2x.png",
      "identifier_ios_57x57_1.png": projName + "/Resources/icons/icon.png",
      "identifier_ios_57x57_2.png": projName + "/Resources/icons/icon-60.png",
    ...
    if( isAll || selected.indexOf(platform) >= 0 ) {
        ...
        Object.keys(files).forEach(function(key) {
            ...
            fs.exists(dest, function(exists) {
                // console.log('file ' + dest + (exists ?" exists." : " does not exist."))
                if (exists) {
